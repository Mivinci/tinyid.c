...
static inline int64_t expand(int64_t x, int64_t mask, int bs) {
    return (x & ~mask) | reverse(x&mask, bs);
}

static inline int64_t shorten(int64_t x, int64_t mask, int bs) {
    return (x & ~mask) | recover(x&mask, bs);
}

static inline int64_t shuffle(int64_t x, int64_t mask, int bs, int64_t(*shuffler)(int64_t, int)) {
